          ...
          <div className="lg:col-span-12 xl:col-span-5 space-y-8">
            <div className="p-6 bg-[#111232] border-4 border-[#111232] rounded-xl neo-brutal-border-lime">
                ...
                {activeTab === "PHILOSOPHY" && (
                  ...
                  >
                    <div className="flex items-center space-x-3 text-brand-pink">
                      ...
                      <h3 className="font-display text-xs uppercase text-brand-pink">{t("philosophy_title")}</h3>
                    </div>
              ...
              <div className="flex items-center justify-between border-t border-brand-lime/20 pt-4">
                <span className="font-mono text-[9px] text-brand-pale/50 uppercase">LOVES FROM MARACAIBO TO THE GLOBE 🌴</span>
          ...
          <div className="lg:col-span-12 xl:col-span-4 space-y-6">
            <div className="p-6 bg-brand-bg/90 border-4 border-[#111232] rounded-xl neo-brutal-border-pink relative overflow-hidden">
              ...
              <div className="flex items-center justify-between mb-6">
                ...
                <span className="font-mono text-[9px] text-brand-pale/50 uppercase">CLICK GAUGE TO SYNC DATA</span>
              </div>
                ...
                {stats.map((s) => {
                  ...
                  return (
                    <div
                      ...
                      role="button"
                      tabIndex={0}
                      onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); handleStatBoost(s.id); } }}
